...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('comissao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='comissoes.Comissao', verbose_name='Comissão')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cargo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='comissoes.CargoComissao')),
                ('composicao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='comissoes.Composicao')),
        ...
        migrations.AddField(
            ...
            name='periodo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='comissoes.Periodo', verbose_name='Período'),
        ),
        migrations.AddField(
            model_name='comissao',
            name='tipo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='comissoes.TipoComissao', verbose_name='Tipo'),
        ),
    ]
